...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='商品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `refund_order` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='退款的订单表信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='用户信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` (`id`, `username`, `password`, `nick_name`, `age`, `avatar`, `sex`, `address`, `role`) VALUES (17,'admin','202cb962ac59075b964b07152d234b70','admin',20,'http://localhost:9090/files/1dacd3720e9446dbbf72f8d0c15f84e2_6e188046f8e0259a.jpg','未知','南昌航空大学八栋菜鸟驿站',1),(22,'21045312','9a025c66a91da1ca28c395025fae5623','lifeng',20,NULL,'女','江西省南昌市',1),(24,'111','698d51a19d8a121ce581499d7b701668',NULL,NULL,NULL,NULL,NULL,2);
...
CREATE TABLE `user_advice` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='用户建议表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-06-25 17:16:27
