...
INSERT INTO `address` (`id`, `user_id`, `phone`, `address`, `add_detail`, `add_name`) VALUES (5,22,'19890145501','北京市 市辖区 西城区','江西省南昌市红谷滩区沙井街道丰和南大道696号南昌航空大学','lf'),(6,25,'78412346666','吉林省 长春市 南关区','lll','li');
...
CREATE TABLE `refund_order` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='退款的订单表信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='用户信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_advice` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='用户建议表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-06-27 13:28:41
